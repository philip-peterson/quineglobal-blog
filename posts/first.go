...
var lookWhereYoureHeaded = model.QuinePost{
	...
	Content: []Node{
		Div(
			...
			P(Text("As humans, we want to know where we're going. But also, due to our psychology, we tend to *go where we are knowing*. If we know about left, we will go left, almost involuntarily. And if you look straight down while lifting a weight, your back and neck will do bad things they were never supposed to do.")),
			...
			P(Text("Follow this blog for more technology insights in business through [RSS](http://blog.quinefoundation.com/rss.xml), or you can [find us on LinkedIn](https://www.linkedin.com/company/quine-foundation).")),
		),
	},
}
